...
#[tauri::command]
fn run_c_program(function: &str, args: Vec<String>) -> String {
    ...
    // Execute the C program with the function argument and any additional args
    let mut command = Command::new(&c_program_path);
